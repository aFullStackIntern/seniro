    ...
    <>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Link href="/Features" className="navlinkli-link">
                  <Box
                    display={"flex"}
            ...
            >
              ...
              >
                <Link href="/Solutions" className="navlinkli-link">
                  <Box
                    display={"flex"}
                    justifyContent="center"
                    alignItems={"center"}
                ...
                >
                  ...
                  >
                    ...
                    <Link href="/Solutions/By-Size" className="popperLinks">
                      <Typography
                        sx={{
                          "&:hover": {
                            color: "#F15B25",
                    ...
                    <Link href="/Solutions/By-role" className="popperLinks">
                      <Typography
                        sx={{
                          "&:hover": {
                            color: "#F15B25",
                    ...
                    <Link href="/Solutions/By-usecases" className="popperLinks">
                      <Typography
                        sx={{
                          "&:hover": {
                            color: "#F15B25",
            ...
            >
              ...
              >
                <Link href="/Resources" className="navlinkli-link">
                  <Box
                    display={"flex"}
                    justifyContent="center"
                    alignItems={"center"}
                ...
                >
                  ...
                  >
                    ...
                    <Link href="/Resources/Blog" className="popperLinks">
                      <Typography
                        sx={{
                          "&:hover": {
                            color: "#F15B25",
                    ...
                    <Link href="/Resources/CaseStudy" className="popperLinks">
                      <Typography
                        sx={{
                          "&:hover": {
                            color: "#F15B25",
                    ...
                    <Link href="/Resources/Videos" className="popperLinks">
                      <Typography
                        sx={{
                          "&:hover": {
                            color: "#F15B25",
                    ...
                    <Link href="/Resources/faq" className="popperLinks">
                      <Typography
                        sx={{
                          "&:hover": {
                            color: "#F15B25",
            ...
            >
              ...
              >
                <Link href="/Pricing" className="navlinkli-link">
                  <Box
                    display={"flex"}
                    justifyContent="center"
                    alignItems={"center"}
      ...
      >
        ...
        >
          ...
          >
            <Link href="/">
              <Image src={logoLight} alt="" fill objectFit="contain" />
            </Link>
          </Stack>
        ...
        >
          ...
          >
            ...
            <AccordionDetails>
              <Stack justifyContent={"center"} gap={1} marginLeft={"20px"}>
                <Link href="/Features/Billing-module" className="popperLinks">
          ...
          >
            ...
            <AccordionDetails>
              <Stack justifyContent={"center"} gap={1} marginLeft={"20px"}>
                <Link href="/Solutions/By-Industries" className="popperLinks">
                  <Typography fontFamily={"Work Sans"} sx={{}}>
                    By Industries
                  </Typography>
                </Link>
          ...
          >
            ...
            <AccordionDetails>
              <Stack justifyContent={"center"} gap={1} marginLeft={"20px"}>
                <Link href="/Resources/BecomeAPartner" className="popperLinks">
                  <Typography fontFamily={"Work Sans"} sx={{}}>
                    Become A Partner
                  </Typography>
                </Link>
                ...
                <Link href="/Resources/Testimonials" className="popperLinks">
                  <Typography fontFamily={"Work Sans"} sx={{}}>
                    Testimonials
                  </Typography>
                </Link>
